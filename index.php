...
<head>
    ...
    <style>
        body {
            background: url(https://wallpaperaccess.com/full/1190462.jpg);
...
<body>
    <nav class="navbar navbar-expand-lg navbar-light">
        <a class="navbar-brand" href="#">
            <img src="https://th.bing.com/th?id=OIP.rToxO6imS9XcsIysdZw2_AHaHa&w=250&h=250&c=8&rs=1&qlt=90&o=6&dpr=1.3&pid=3.1&rm=2" width="30" height="30" class="d-inline-block align-top" alt="Softball Logo">
            <span style="color: white;">Nat's Store</span>
        </a>
